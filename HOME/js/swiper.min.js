...
! function(e, t) {
    ...
    var ie = {
        ...
        oe = {
            ...
            in: function(e) {
                var t, i, a, r, n, o, l, d, h, p, c, u, v, f, m, g, b = this.assetsm,
                    w = this.params.assetsm,
                    y = b.gesture,
                    x = b.image;
            ...
            enable: function() {
                ...
                if (!e.enabled) {
                    ...
                    o.gestures ? (this.$wrapperEl.on("gesturestart", ".swiper-slide", e.onGestureStart, t), this.$wrapperEl.on("gesturechange", ".swiper-slide", e.onGestureChange, t), this.$wrapperEl.on("gestureend", ".swiper-slide", e.onGestureEnd, t)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.on(this.touchEvents.start, ".swiper-slide", e.onGestureStart, t), this.$wrapperEl.on(this.touchEvents.move, ".swiper-slide", e.onGestureChange, i), this.$wrapperEl.on(this.touchEvents.end, ".swiper-slide", e.onGestureEnd, t), this.touchEvents.cancel && this.$wrapperEl.on(this.touchEvents.cancel, ".swiper-slide", e.onGestureEnd, t)), this.$wrapperEl.on(this.touchEvents.move, "." + this.params.assetsm.containerClass, e.onTouchMove, i)
                }
            },
            disable: function() {
                var e = this.assetsm;
                if (e.enabled) {
                    this.assetsm.enabled = !1;
                    var t = !("touchstart" !== this.touchEvents.start || !o.passiveListener || !this.params.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        },
        ...
        we = [R, q, K, U, Z, J, te, {
            ...
            params: {
                assetsm: {
                    ...
                    minRatio: 1,
                    toggle: !0,
                    containerClass: "swiper-assetsm-container",
                    assetsmedSlideClass: "swiper-slide-assetsmed"
                }
            },
            create: function() {
                var e = this,
                ...
                var i = 1;
                Object.defineProperty(e.assetsm, "scale", {
                    get: function() {
                        return i
                    },
                    set: function(t) {
                        if (i !== t) {
                            var s = e.assetsm.gesture.$imageEl ? e.assetsm.gesture.$imageEl[0] : void 0,
                                a = e.assetsm.gesture.$slideEl ? e.assetsm.gesture.$slideEl[0] : void 0;
                            e.emit("assetsmChange", t, s, a)
                        }
                        i = t
                    }
                })
            ...
            on: {
                init: function() {
                    this.params.assetsm.enabled && this.assetsm.enable()
                },
                destroy: function() {
                    this.assetsm.disable()
                },
                touchStart: function(e) {
                    this.assetsm.enabled && this.assetsm.onTouchStart(e)
                },
                touchEnd: function(e) {
                    this.assetsm.enabled && this.assetsm.onTouchEnd(e)
                },
                doubleTap: function(e) {
                    this.params.assetsm.enabled && this.assetsm.enabled && this.params.assetsm.toggle && this.assetsm.toggle(e)
                },
                transitionEnd: function() {
                    this.assetsm.enabled && this.params.assetsm.enabled && this.assetsm.onTransitionEnd()
                },
                slideChange: function() {
                    this.assetsm.enabled && this.params.assetsm.enabled && this.params.cssMode && this.assetsm.onTransitionEnd()
                }
            }
        }, {
            name: "lazy",
